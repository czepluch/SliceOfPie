...
%Include references to factor table (missing)
...
\input{Software_architecture/decisions} % missing

\input{Software_architecture/logical}

\input{Software_architecture/process} % missing

\input{Software_architecture/deployment}

\input{Software_architecture/data} % missing

\input{Software_architecture/implementation} % missing

\input{Software_architecture/development} %missing

\input{Software_architecture/usecase} % missing