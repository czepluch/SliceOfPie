...
sharing-system, called \SOP{}, which mixes some of the functionality of Google Drive and Dropbox with
...
\end{itemize}
\paragraph{Our Slice}
Like Google Drive, \SOP{} allows the user to create, edit, and share documents through a web interface.
